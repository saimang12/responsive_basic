...
<meta name="NaverBot" content="All" />
    ...
    <meta name="title" content="<?=$as_title?>">
    <meta name="description" content="<?=$as_description?>">
    <meta name="keywords" content="<?=$as_description?>">

    <meta property="og:type" content="article">
    <meta property="og:title" content="<?=$as_btitle?> <?=$as_title?>">
    <meta property="og:description" content="<?=$as_description?>">
    <meta property="og:url" content="<?php echo G5_URL; ?>">
    <meta property="og:image" content="<?php echo G5_THEME_URL; ?>/img/logo.png">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="<?=$as_btitle?> <?=$as_title?>">
    <meta name="twitter:description" content="<?=$as_description?>">
    <meta name="twitter:url" content="<?php echo G5_URL; ?>">
    <meta name="twitter:image" content="<?php echo G5_THEME_URL; ?>/img/logo.png">
...
add_javascript('<script src="'.G5_THEME_URL.'/js/main.js?ver=1.2"></script>', 100);
